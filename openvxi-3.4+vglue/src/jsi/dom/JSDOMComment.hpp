...
#ifndef _JSDOMCOMMENT_H_
#define _JSDOMCOMMENT_H_
...
class JSDOMComment : public JSDOMCharacterData
{
public:
	...
	JSDOMComment(DOMComment *comment, JSDOMDocument *doc = NULL);
	virtual ~JSDOMComment(){}
